...
def run_inactivity_check(db: Session = Depends(get_db), authorized: bool = Depends(verify_cron_secret)):
    ...
    if len(tasks_today) == 0:
        ...
        <p>Open Momentum: <a href="https://momentum-kappa-nine.vercel.app/">https://momentum-kappa-nine.vercel.app/</a></p>
        {weekly_goals_html}
        """
        return {
...
def run_weekly_goals_reminder(db: Session = Depends(get_db), authorized: bool = Depends(verify_cron_secret)):
    ...
    <p>Open Momentum and knock them out: <a href="https://momentum-kappa-nine.vercel.app/">https://momentum-kappa-nine.vercel.app/</a></p>
    """
